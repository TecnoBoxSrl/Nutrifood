...
function createShareBar({title, text, url, node}){
  ...
  const actions = el('div',{class:'share-bar'},[
    el('button',{
      type:'button',
      class:'share-action',
      onClick:()=>printSection(node,title),
      'aria-label':'Stampa',
      title:'Stampa'
    },[
      el('span',{'class':'share-icon','aria-hidden':'true'},['🖨️']),
      el('span',{'class':'sr-only'},['Stampa'])
    ]),
    el('a',{
      href:mailHref,
      target:'_blank',
    ...
    el('a',{
      ...
      el('span',{'class':'share-icon','aria-hidden':'true'},[
        el('img',{
      ...
      el('span',{'class':'sr-only'},['WhatsApp'])
    ]),
    el('a',{
      href:facebookHref,
      target:'_blank',
      ...
      el('span',{'class':'sr-only'},['Facebook'])
    ]),
    el('a',{
      href:instagramHref,
      target:'_blank',
      ...
      el('span',{'class':'sr-only'},['Instagram'])
    ])
  ]);
  return actions;
}
